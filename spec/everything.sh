...
# We actually want to run our destroy at the end, even if there are errors.
...
! ruby scripts/destroy.rb && ( echo $NAME | ruby scripts/destroy.rb --unsafe --name $NAME --debug )